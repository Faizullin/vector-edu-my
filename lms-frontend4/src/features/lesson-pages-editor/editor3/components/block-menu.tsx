...
export function BlockMenu({
  ...
  const { duplicateBlock, removeBlock, updateBlockField } = useEditor();
  ...
  }, [block, blockId, updateBlockField]);
  return (
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent side="right" align="start">
          ...
          <DropdownMenuItem
            ...
            disabled={!block.data.template_id}
          >
            <ImportIcon className="mr-2 h-4 w-4" />
            <span>Detach</span>
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => duplicateBlock(blockId)} className="cursor-pointer">
            <CopyIcon className="mr-2 h-4 w-4" />
            <span>Duplicate</span>
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => removeBlock(blockId)} className="cursor-pointer">
